...
import org.wuerthner.cwn.midi.util.MidiUtil;
...
public class MidiFile
{
    ...
    public void writeToOutputStream(OutputStream os) throws FileNotFoundException, IOException
    {
        // FileOutputStream fout = new FileOutputStream(outFile);

        os.write(IDENTIFIER);
        os.write(MidiUtil.intToBytes(6, 4));
        os.write(MidiUtil.intToBytes(mType, 2));
        os.write(MidiUtil.intToBytes(mTrackCount, 2));
        os.write(MidiUtil.intToBytes(mResolution, 2));
